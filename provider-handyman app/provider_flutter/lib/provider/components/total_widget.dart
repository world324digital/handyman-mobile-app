      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              SizedBox(width: context.width() / 2 - 94, child: AutoSizeText(total.validate(), style: boldTextStyle(color: Colors.white, size: 18), maxLines: 1)),
              Container(
          ...
          8.height,
          Text(title, style: secondaryTextStyle(size: 14, color: Colors.white)),
        ],
      ),
    );
  }
